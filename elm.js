...
var $author$project$Main$PreviewView = {$: 'PreviewView'};
var $tesk9$palette$Palette$Cubehelix$BGR = {$: 'BGR'};
...
var $tesk9$palette$Internal$HSLA$Color = function (a) {
	return {$: 'Color', a: a};
};
...
var $tesk9$palette$Internal$HSLA$fromChannels = function (_v0) {
	...
	return $tesk9$palette$Internal$HSLA$Color(
		{
			alpha: alpha,
			hue: hue360 + floatingHueValues,
			lightness: A3($elm$core$Basics$clamp, 0, 100, lightness),
			saturation: A3($elm$core$Basics$clamp, 0, 100, saturation)
		});
};
...
var $tesk9$palette$Color$fromHSL = function (_v0) {
	...
	return $tesk9$palette$Color$Color(
		$tesk9$palette$Internal$Color$fromHSLA(
			{alpha: $tesk9$palette$Internal$Opacity$opaque, hue: hue, lightness: lightness, saturation: saturation}));
};
var $tesk9$palette$Palette$Cubehelix$defaultConfig = {
	gamma: 1.0,
	rotationDirection: $tesk9$palette$Palette$Cubehelix$BGR,
	rotations: 1.5,
	start: $tesk9$palette$Color$fromHSL(
		_Utils_Tuple3(-60, 100, 0))
};
...
var $tesk9$palette$Palette$Cubehelix$colorAtStep = F2(
	function (i, _v0) {
		var rotations = _v0.rotations;
		var start = _v0.start;
		var fract = _v0.fract;
		var gamma = _v0.gamma;
		var saturation = _v0.saturation;
		var fract_ = A2(
			...
			fract(i),
			gamma);
		var angle = (2 * $elm$core$Basics$pi) * (((start / 3.0) + 1.0) + (rotations * fract(i)));
		var amp = ((saturation * fract_) * (1 - fract_)) / 2.0;
		var blue = fract_ + (amp * (1.97294 * $elm$core$Basics$cos(angle)));
		var green = fract_ + (amp * (((-0.29227) * $elm$core$Basics$cos(angle)) - (0.90649 * $elm$core$Basics$sin(angle))));
		var red = fract_ + (amp * (((-0.14861) * $elm$core$Basics$cos(angle)) + (1.78277 * $elm$core$Basics$sin(angle))));
		return $tesk9$palette$Color$fromRGB(
			_Utils_Tuple3(red * 255, green * 255, blue * 255));
	});
...
var $tesk9$palette$Internal$HSLA$fromRGBA = function (_v0) {
	var red = _v0.red;
	var green = _v0.green;
	var blue = _v0.blue;
	var alpha = _v0.alpha;
	var _v1 = _Utils_Tuple3(red / 255, green / 255, blue / 255);
	var r = _v1.a;
	var g = _v1.b;
	var b = _v1.c;
	var maximum = A2(
	...
	return $tesk9$palette$Internal$HSLA$fromChannels(
		{alpha: alpha, hue: hue, lightness: lightness * 100, saturation: saturation * 100});
};
...
var $tesk9$palette$Color$toHSL = function (_v0) {
	var color = _v0.a;
	var _v1 = $tesk9$palette$Internal$HSLA$toChannels(
		$tesk9$palette$Internal$Color$asHSLA(color));
	var hue = _v1.hue;
	var saturation = _v1.saturation;
	var lightness = _v1.lightness;
	return _Utils_Tuple3(hue, saturation, lightness);
};
var $tesk9$palette$Palette$Cubehelix$toInternalConfig = F2(
	function (_v0, numLevels) {
		var start = _v0.start;
		var rotationDirection = _v0.rotationDirection;
		var rotations = _v0.rotations;
		var gamma = _v0.gamma;
		var positiveClampedRotations = A3(
			$elm$core$Basics$clamp,
			0,
			1.5,
			$elm$core$Basics$abs(rotations));
		var _v1 = $tesk9$palette$Color$toHSL(start);
		var hue = _v1.a;
		var sat = _v1.b;
		return {
			fract: function (i) {
				return i / (numLevels - 1);
			},
			gamma: A3($elm$core$Basics$clamp, 0, 2, gamma),
			rotations: function () {
				if (rotationDirection.$ === 'RGB') {
					return positiveClampedRotations;
				} else {
					return -positiveClampedRotations;
				}
			}(),
...
var $tesk9$palette$Palette$Cubehelix$generateAdvanced = F2(
	function (numLevels, config) {
		var clampedNumLevels = A3($elm$core$Basics$clamp, 0, 256, numLevels);
		var internalConfig = A2($tesk9$palette$Palette$Cubehelix$toInternalConfig, config, clampedNumLevels);
		var generate_ = function (colors) {
			generate_:
			while (true) {
				if (_Utils_cmp(
					...
					var $temp$colors = A2(
						$elm$core$List$cons,
						A2(
							$tesk9$palette$Palette$Cubehelix$colorAtStep,
							$elm$core$List$length(colors),
							internalConfig),
						colors);
					colors = $temp$colors;
...
var $tesk9$palette$Palette$Cubehelix$generate = function (numLevels) {
	return A2($tesk9$palette$Palette$Cubehelix$generateAdvanced, numLevels, $tesk9$palette$Palette$Cubehelix$defaultConfig);
};
var $author$project$Main$colorPalette = $tesk9$palette$Palette$Cubehelix$generate(20);
...
var $author$project$Main$defaultPreferences = {
	backgroundColor: A2(
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$tesk9$palette$Color$toRGB,
					function (_v0) {
						var r = _v0.a;
						var g = _v0.b;
						var b = _v0.c;
						return A3($author$project$Main$rgb255, r, g, b);
					}),
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Main$Model, $elm$core$Dict$empty, $author$project$Main$defaultPreferences, $author$project$Main$PreviewView),
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$StepSlideshow = function (a) {
	return {$: 'StepSlideshow', a: a};
};
var $author$project$Main$TogglePauseSlideshow = {$: 'TogglePauseSlideshow'};
...
var $author$project$Main$isEsc = function (string) {
	if (string === 'Escape') {
		return $elm$json$Json$Decode$succeed(string);
	} else {
		return $elm$json$Json$Decode$fail('Not the Escape Key');
	}
};
...
var $author$project$Main$toDirection = function (string) {
	switch (string) {
		case 'ArrowLeft':
			return $elm$core$Maybe$Just($author$project$Main$Backward);
		case 'ArrowRight':
			return $elm$core$Maybe$Just($author$project$Main$Forward);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$isNavKey = function (string) {
	var _v0 = $author$project$Main$toDirection(string);
	if (_v0.$ === 'Just') {
		var direction = _v0.a;
		return $elm$json$Json$Decode$succeed(direction);
	} else {
		return $elm$json$Json$Decode$fail('Not a Direction Key');
	}
};
var $author$project$Main$isSpace = function (string) {
	if (string === ' ') {
		return $elm$json$Json$Decode$succeed(' ');
	} else {
		return $elm$json$Json$Decode$fail('Not the Space Key');
	}
};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Main$msgWhen = F2(
	function (keyDecoder, msg) {
		return A2(
			$elm$json$Json$Decode$map,
			msg,
			A2(
...
var $author$project$Main$startSlideshow = function (slides) {
	return $author$project$Main$ChangeView(
		$author$project$Main$SlideshowView(
			{running: true, slidelist: slides}));
};
var $author$project$Main$subscriptions = function (model) {
	var data = model.a;
	var slideshowSpeed = model.b.slideshowSpeed;
	var state = model.c;
	switch (state.$) {
		case 'SlideshowView':
			var running = state.a.running;
			var navigationListeners = _List_fromArray(
				[
					$elm$browser$Browser$Events$onKeyPress(
					A2(
						$author$project$Main$msgWhen,
						$author$project$Main$isSpace,
						$elm$core$Basics$always($author$project$Main$TogglePauseSlideshow))),
					$elm$browser$Browser$Events$onKeyUp(
					A2($author$project$Main$msgWhen, $author$project$Main$isNavKey, $author$project$Main$StepSlideshow)),
					$elm$browser$Browser$Events$onKeyUp(
					A2(
						$author$project$Main$msgWhen,
						$author$project$Main$isEsc,
						$elm$core$Basics$always(
							$author$project$Main$ChangeView($author$project$Main$PreviewView))))
				]);
			if (running) {
				return $elm$core$Platform$Sub$batch(
					A2(
						...
						A2(
							...
							slideshowSpeed,
							$elm$core$Basics$always(
								$author$project$Main$StepSlideshow($author$project$Main$Forward))),
						navigationListeners));
			} else {
				return $elm$core$Platform$Sub$batch(navigationListeners);
			}
		case 'PreviewView':
...
var $author$project$Main$ImageFilesReceived = F2(
	function (a, b) {
		return {$: 'ImageFilesReceived', a: a, b: b};
	});
...
var $author$project$Main$ImageUrlEncoding = F2(
	function (a, b) {
		return {$: 'ImageUrlEncoding', a: a, b: b};
	});
...
var $author$project$Main$getFileAsImageUrl = function (file) {
	return A2(
		$elm$core$Task$attempt,
		$author$project$Main$ImageUrlEncoding(
			$elm$file$File$name(file)),
		$elm$file$File$toUrl(file));
};
var $author$project$Main$toggleRunning = A2(
	$elm$core$Basics$composeL,
	$elm$core$Basics$not,
	function ($) {
		return $.running;
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'ImagesRequested':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['image/png', 'image/jpg']),
						$author$project$Main$ImageFilesReceived));
			case 'ImageFilesReceived':
				var file = msg.a;
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						A2(
							$elm$core$List$map,
							$author$project$Main$getFileAsImageUrl,
							A2($elm$core$List$cons, file, otherFiles))));
			case 'ImageUrlEncoding':
				var filename = msg.a;
				var result = msg.b;
				if (result.$ === 'Ok') {
					var imageUrl = result.a;
					var images = model.a;
					var preferences = model.b;
					var state = model.c;
					return _Utils_Tuple2(
						A3(
							$author$project$Main$Model,
							A3($elm$core$Dict$insert, filename, imageUrl, images),
							preferences,
							state),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 'StepSlideshow':
				...
				var preferences = model.b;
				var state = model.c;
				if (state.$ === 'SlideshowView') {
					var slideshowState = state.a;
					var stepList = function (list) {
						if (list.b) {
							var head = list.a;
							var tail = list.b;
							return A2(
							...
							A3(
								...
								$author$project$Main$SlideshowView(
									_Utils_update(
										slideshowState,
										{
											slidelist: stepList(slideshowState.slidelist)
										}))),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(
							A3(
								...
								$author$project$Main$SlideshowView(
									_Utils_update(
										slideshowState,
										{
											slidelist: $elm$core$List$reverse(
												stepList(
													$elm$core$List$reverse(slideshowState.slidelist)))
										}))),
							$elm$core$Platform$Cmd$none);
					}
				} else {
						...
						A3(
							...
							$author$project$Main$SlideshowView(
								_Utils_update(
									slideshowState,
									{
										running: $author$project$Main$toggleRunning(slideshowState)
									}))),
						$elm$core$Platform$Cmd$none);
				} else {
					return noop;
			...
			case 'SetBackgroundColor':
				...
				return _Utils_Tuple2(
					A3(
						...
						state),
					$elm$core$Platform$Cmd$none);
			case 'SetSlideshowInterval':
				var newInterval = msg.a;
				var data = model.a;
				var preferences = model.b;
				var state = model.c;
				return _Utils_Tuple2(
					A3(
						...
						_Utils_update(
							preferences,
							{slideshowSpeed: newInterval}),
						state),
					$elm$core$Platform$Cmd$none);
			case 'SetElementsPerRow':
				var count = msg.a;
				var data = model.a;
				var preferences = model.b;
				var state = model.c;
			...
			default:
				...
				var preferences = model.b;
				return _Utils_Tuple2(
					A3($author$project$Main$Model, data, preferences, newState),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$SetElementsPerRow = function (a) {
	return {$: 'SetElementsPerRow', a: a};
};
var $author$project$Main$SetSlideshowInterval = function (a) {
	return {$: 'SetSlideshowInterval', a: a};
};
...
var $author$project$Main$colorBox = function (color) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$SetBackgroundColor(color))
			]),
		A2($mdgriffith$elm_ui$Element$column, _List_Nil, _List_Nil));
};
var $author$project$Main$colorPicker = A2(
	$elm$core$List$map,
	A2(
		$elm$core$Basics$composeR,
		$tesk9$palette$Color$toRGB,
...
var $author$project$Main$editPreferencesView = function (_v0) {
	var slideshowSpeed = _v0.slideshowSpeed;
	var backgroundColor = _v0.backgroundColor;
	var previewItemsPerRow = _v0.previewItemsPerRow;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				[
						...
						label: A2(
							...
							_List_fromArray(
								[
									...
									A4($mdgriffith$elm_ui$Element$rgba255, 250, 250, 250, 1.0)),
									$mdgriffith$elm_ui$Element$width(
									$mdgriffith$elm_ui$Element$fillPortion(1))
								]),
							$mdgriffith$elm_ui$Element$text(
								'Slideshow Speed = ' + ($elm$core$String$fromFloat(
									$elm$core$Basics$round(slideshowSpeed / 100) / 10) + 's'))),
						max: 60 * 1000,
						min: 100,
						onChange: $author$project$Main$SetSlideshowInterval,
						...
						]),
					{
						label: A2(
							...
							$mdgriffith$elm_ui$Element$text(
								'Images per Row = ' + $elm$core$String$fromInt(previewItemsPerRow))),
						max: 10,
						min: 1,
						onChange: A2($elm$core$Basics$composeR, $elm$core$Basics$round, $author$project$Main$SetElementsPerRow),
						step: $elm$core$Maybe$Just(1),
						thumb: $mdgriffith$elm_ui$Element$Input$defaultThumb,
						value: previewItemsPerRow
					}),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('Background Color')),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
								[
...
var $author$project$Main$singleFileView = function (fileSrc) {
	return A2(
...
var $author$project$Main$filePreviewView = F2(
	function (files, preferences) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$Background$color(preferences.backgroundColor),
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$elm$core$List$map($author$project$Main$singleFileView),
					$mdgriffith$elm_ui$Element$row(
						_List_fromArray(
							[
				...
				A2($elm_community$list_extra$List$Extra$greedyGroupsOf, preferences.imagesPerRow, files)));
	});
var $author$project$Main$ImagesRequested = {$: 'ImagesRequested'};
var $author$project$Main$PreferencesView = {$: 'PreferencesView'};
...
var $author$project$Main$rgbTuple = function (_v0) {
	var r = _v0.a;
	var g = _v0.b;
	var b = _v0.c;
	return A3($author$project$Main$rgb255, r, g, b);
};
var $author$project$Main$imageHeader = function (model) {
	var headerBackground = A2(
		$elm$core$Maybe$withDefault,
		A3($author$project$Main$rgb255, 0, 0, 0),
		A2(
			$elm_community$list_extra$List$Extra$getAt,
			3,
			A2(
				$elm$core$List$map,
				A2($elm$core$Basics$composeR, $tesk9$palette$Color$toRGB, $author$project$Main$rgbTuple),
				$author$project$Main$colorPalette)));
	var fontColor = A2(
		$elm$core$Maybe$withDefault,
		A3($author$project$Main$rgb255, 0, 0, 0),
		...
		case 'EditPreferences':
			return A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$Background$color(headerBackground),
						$mdgriffith$elm_ui$Element$spaceEvenly,
						$mdgriffith$elm_ui$Element$padding(5)
					]),
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text('Preview View')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$ImagesRequested),
								$mdgriffith$elm_ui$Element$Font$color(fontColor)
							]),
						$mdgriffith$elm_ui$Element$text('Select Images'))
					]));
		case 'ImageList':
			var imageUrls = model.a;
			return A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Events$onClick(
								$author$project$Main$ChangeView($author$project$Main$PreferencesView)),
								$mdgriffith$elm_ui$Element$Font$color(fontColor)
							]),
						$mdgriffith$elm_ui$Element$text('Preferences')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
			...
			return A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$Background$color(
						A4($mdgriffith$elm_ui$Element$rgba255, 220, 220, 220, 0.5)),
						$mdgriffith$elm_ui$Element$spaceEvenly,
						$mdgriffith$elm_ui$Element$padding(5)
					]),
				_List_fromArray(
...
var $author$project$Main$slideshowView = F2(
	function (imageUrl, backgroundColor) {
		var url = imageUrl;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$Main$imageViewer = function (model) {
		...
		switch (model.$) {
			case 'ImageList':
				...
				return A2(
					...
					_List_fromArray(
						[
							$author$project$Main$imageHeader(model),
							A2(
							$author$project$Main$filePreviewView,
							A2($elm$core$List$map, $elm$core$Tuple$second, images),
							preferences)
						]));
			case 'Slideshow':
				var currentImage = model.a;
				var backgroundColor = model.b.backgroundColor;
				return A2($author$project$Main$slideshowView, currentImage, backgroundColor);
			default:
				var preferences = model.a;
				return A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$author$project$Main$imageHeader(model),
							$author$project$Main$editPreferencesView(preferences)
						]));
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$defaultPreferences.backgroundColor)
			]),
		content);
};
var $author$project$Main$EditPreferences = function (a) {
	return {$: 'EditPreferences', a: a};
};
var $author$project$Main$ImageList = F2(
	function (a, b) {
		return {$: 'ImageList', a: a, b: b};
	});
var $author$project$Main$Slideshow = F2(
	function (a, b) {
		return {$: 'Slideshow', a: a, b: b};
	});
var $author$project$Main$getFromDict = F2(
	function (dict, key) {
		return A2($elm$core$Dict$get, key, dict);
	});
var $author$project$Main$viewSelector = function (model) {
	var data = model.a;
	var preferences = model.b;
	var viewState = model.c;
	var imageList = $elm$core$Dict$toList(data);
	switch (viewState.$) {
		case 'PreferencesView':
			return $author$project$Main$EditPreferences(preferences);
		case 'PreviewView':
			return A2(
				$author$project$Main$ImageList,
				imageList,
				{backgroundColor: preferences.backgroundColor, imagesPerRow: preferences.previewItemsPerRow});
		default:
			var running = viewState.a.running;
			var slidelist = viewState.a.slidelist;
			var _v2 = A2(
				$elm$core$List$filterMap,
				$author$project$Main$getFromDict(data),
				slidelist);
			if (!_v2.b) {
				return A2(
					$author$project$Main$ImageList,
				...
				var firstImage = _v2.a;
				var images = _v2.b;
				return A2(
					$author$project$Main$Slideshow,
					firstImage,
					{backgroundColor: preferences.backgroundColor});
			}
	}
};
var $author$project$Main$view = A2($elm$core$Basics$composeR, $author$project$Main$viewSelector, $author$project$Main$imageViewer);
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Element.Color":{"args":[],"type":"Internal.Model.Color"},"Main.ImageUrl":{"args":[],"type":"String.String"},"Main.ImageKey":{"args":[],"type":"String.String"},"Main.SlideshowState":{"args":[],"type":"{ running : Basics.Bool, slidelist : List.List Main.ImageKey }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"ImagesRequested":[],"ImageFilesReceived":["File.File","List.List File.File"],"ImageUrlEncoding":["String.String","Result.Result () Main.ImageUrl"],"StepSlideshow":["Main.Direction"],"TogglePauseSlideshow":[],"SetSlideshowInterval":["Basics.Float"],"SetBackgroundColor":["Element.Color"],"SetElementsPerRow":["Basics.Int"],"ChangeView":["Main.ViewState"]}},"Internal.Model.Color":{"args":[],"tags":{"Rgba":["Basics.Float","Basics.Float","Basics.Float","Basics.Float"]}},"Main.Direction":{"args":[],"tags":{"Forward":[],"Backward":[]}},"File.File":{"args":[],"tags":{"File":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Main.ViewState":{"args":[],"tags":{"SlideshowView":["Main.SlideshowState"],"PreviewView":[],"PreferencesView":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}}}}})}});}(this));